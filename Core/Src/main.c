...
/* USER CODE BEGIN PV */
volatile uint8_t time_flags = 0;
extern uint16_t filtered_adc_buffer[ADC_CHANNEL_COUNT];
...
/* USER CODE BEGIN PFP */
extern bool ADC_ReadAverage(uint16_t *avg_buffer, TickType_t timeout_ms);
/* USER CODE END PFP */
...
/* USER CODE BEGIN Header_GeneralTask */
/**
